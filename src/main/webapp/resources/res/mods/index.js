        ...
        ,picture: function(editor){ //插入图片
          layer.open({
            ...
            ,success: function(layero, index){
              ...
              upload.render({
                elem: '#uploadImg'
                ,url: '../user/uploadHeadImage?src=/resources/img/people'
                ,size: 20000
                ,done: function(res){
                  if(res.code == 0){
                    image.val(res.src);
...
//    }
  ...
  var tplSigninTop = ['{{# layui.each(d.data, function(index, item){ }}'
    ,'<li>'
      ,'<a href="/guomanwang/user/user_home?userId={{item.uid}}" target="_blank">'
        ,'<img src="/guomanwang{{item.avatar}}">'
  ...
  elemSigninTop.on('click', function(){
    ...
    fly.json('/guomanwang/thread/Top20SignUsers', function(res){ //实际使用，请将 url 改为真实接口
      var tpl = $(['<div class="layui-tab layui-tab-brief" style="margin: 5px 0 0;">'
        ,'<ul class="layui-tab-title">'
          ,'<li class="layui-this">签到榜</li>'
        ,'</ul>'
